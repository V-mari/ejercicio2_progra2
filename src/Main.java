...
public class Main {
    public static void main(String[] args) {
        Cliente mariela=new Cliente(1,"mariela","ruth","trujillo");
        //ciudad
        ...
        Billete billete=new Billete(1,Calendar.getInstance().getTime(),556.32,mariela,cochabamba,tarija,turista,vuelos);
